...
const COLLECTIONS = [
  {
    ...
    fields: [
      ...
      { type: 'number', name: 'user_a_status', required: true, min: 0, max: 2, onlyInt: true, defaultValue: '0' },
      { type: 'number', name: 'user_b_status', required: true, min: 0, max: 2, onlyInt: true, defaultValue: '0' },
      { type: 'number', name: 'application_status', required: true, min: 0, max: 3, onlyInt: true, defaultValue: '0' },
  ...
  },
  {
    ...
    fields: [
      ...
      { type: 'number', name: 'session_status', required: true, min: 0, max: 1, onlyInt: true, defaultValue: '1' },
  ...
  },
  {
    ...
    fields: [
      ...
      { type: 'text', name: 'notice', required: false, max: 2000 },
      { type: 'number', name: 'group_type', required: true, min: 1, max: 2, onlyInt: true },
      { type: 'number', name: 'group_status', required: true, min: 1, max: 2, onlyInt: true, defaultValue: '1' },
    ],
    indexes: [
  ...
  },
  {
    ...
    fields: [
      ...
      { type: 'number', name: 'member_role', required: true, min: 1, max: 3, onlyInt: true, defaultValue: '1' },
      { type: 'date', name: 'join_time', required: true },
      { type: 'date', name: 'leave_time', required: false },
      { type: 'number', name: 'is_active', required: true, min: 1, max: 2, onlyInt: true, defaultValue: '1' },
    ],
    indexes: [
  ...
  },
  {
    ...
    fields: [
      ...
      { type: 'number', name: 'message_type', required: true, min: 1, max: 9, onlyInt: true, defaultValue: '1' },
      { type: 'editor', name: 'content', required: false },
      { type: 'url', name: 'file_url', required: false },
      { type: 'number', name: 'duration', required: false, min: 0, onlyInt: true },
  ...
  },
  {
    ...
    fields: [
      { type: 'relation', name: 'sender_id', required: true, collectionId: 'users', cascadeDelete: false, maxSelect: 1 },
      { type: 'relation', name: 'user_id', required: true, collectionId: 'users', cascadeDelete: false, maxSelect: 1 },
      { type: 'number', name: 'notification_type', required: true, min: 0, max: 4, onlyInt: true },
